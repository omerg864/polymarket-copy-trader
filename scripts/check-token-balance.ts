...
async function main() {
    ...
    const tokenId = '114162452542275862061797834319735533292968273214070635310077599228648873314972';
    ...
    try {
        ...
        process.stdout.write(`💰 Balance: ${ethers.utils.formatUnits(balance, 6)} tokens\n`);
    } catch (error) {
