	...
	return (
		<div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
			...
			<header className="border-b border-zinc-800 bg-zinc-900/50 backdrop-blur sticky top-0 z-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 h-auto sm:h-14 py-3 sm:py-0 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6">
					<div className="font-semibold text-zinc-100 flex items-center gap-2">
						<span className="text-xl">📈</span>
						<span>Polymarket 5M Bot</span>
					</div>
					<nav className="flex items-center gap-1 sm:ml-4 sm:border-l border-zinc-800 sm:pl-4 h-8 text-sm">
						<button
